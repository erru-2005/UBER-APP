...
function RidePopUp(props) {
  ...
  return (
    ...
    <div className=" border-2 p-5 border-gray-300 rounded-lg shadow-lg flex flex-col justify-center items-center w-full h-[90%]">
      ...
      <div className="flex items-center justify-between  w-full  px-4 py-2 rounded-lg  bg-[#f0f0f0]">
        <div className="flex items-center justify-start gap-4 w-[80%]">
          ...
          <h2 className="text-2xl font-bold capitalize">{props.newRide?.userId.fullname.firstname +" "+props.newRide?.userId.fullname.lastname }</h2>
        </div>
      ...
      <button
        ...
        className=" bg-green-600 text-white font-semibold rounded-lg px-4 py-2 mt-4 mb-2 w-[90%]"
      >
      ...
      <button
        ...
        className=" bg-gray-300 text-black rounded-lg px-4 py-2 mt-4 mb-2 w-[90%]"
      >
