...
const WaitingForDriver = (props) => {
  return (
    <div className="w-full bg-white flex flex-col  items-center">
      ...
      <div className=" flex justify-between items-center p-6 mb-2 w-full ">
       ...
       <h3 className='capitalize font-bold text-lg'>{props.acceptedRide?.captainId.fullname.firstname}</h3>
        <h2 className='uppercase font-bold text-lg'>{props.acceptedRide?.captainId.vehicle.plate}</h2>
        <p className='text-sm'>Maruki suzuki 800 </p>
        <h1 >OTP: <span className='text-bold  text-yellow-900 text-lg'> {props.acceptedRide?.otp}</span></h1>
       </div>
      </div>
      ...
      <div className="flex gap-4 items-center p-2 border-b-2 border-gray-300 w-full ">
        ...
        <div className="flex  flex-col">
          ...
          <p className="text-sm">{props.acceptedRide?.pickup}</p>
        </div>
      </div>
      {/*to address8*/}
      <div className="flex gap-4 items-center mt-2.5 p-2 border-b-2 border-gray-300 w-full" >
        ...
        <div className="flex flex-col ">
          ...
          <p className="text-sm">{props.acceptedRide?.dropoff}</p>
        </div>
      </div>
      {/* price */}
      <div className="flex gap-4 items-center  mt-2.5 p-2">
        ...
        <div className="flex flex-col ">
          <h3 className="font-bold">₹ {props.acceptedRide?.fare}</h3>
